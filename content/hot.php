...
<html lang="eng">
    ...
    <body>
      ...
      <nav class="flex-div">
          ...
          if(isset($_SESSION["username"])){
            ...
            <div class="nav-right flex-div">
                ...
                <a href="./user_profile.php" style="padding: 10px"><img src="./images/follow.png"></a>
      ...
      <div class="nav-right flex-div">
          ...
          <a href="./create.php"><img src="./images/editor_img.png"></a>
          <a href="./ads.php"><img src="./images/ad.png"></a>
          <a href="./user_profile.php"><img src="./images/follow.png"></a>
    ...
    ?>
      ...
      <div class="sidebar">
          <div class="shortcut-links">
              ...
              <a style="color: orange" href="./hot.php"><p><img src="./images/hot.png"> Hot! </a></p>
